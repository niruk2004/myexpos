...
load --int=9 $HOME/myexpos/spl/spl_progs/int9_stage17.xsm
...
load --module 2 $HOME/myexpos/spl/spl_progs/module2_stage17.xsm
...
load --module 7 $HOME/myexpos/spl/spl_progs/boot_mod_stage17.xsm
